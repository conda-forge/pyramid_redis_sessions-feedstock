...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8735&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyramid_redis_sessions-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyramid_redis_sessions` can be installed with:

```
conda install pyramid_redis_sessions
```

It is possible to list all of the versions of `pyramid_redis_sessions` available on your platform with:
